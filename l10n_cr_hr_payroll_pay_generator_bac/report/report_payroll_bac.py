...
class PayrollBacReport(models.AbstractModel):

    _name = 'report.l10n_cr_hr_payroll_pay_generator_bac.report_payroll_bac'
...
WHERE PAYSLIP.id = %s""", [salary_rule_id, salary_rule_id, slip.id])
    ...
    def render_html(self, cr, uid, ids, data=None, context=None):
        ...
        report = report_obj._get_xls_report_from_name(
            cr, uid,
            'l10n_cr_hr_payroll_pay_generator_bac.report_payroll_bac')
