...
class bac_export(osv.osv):
    '''BAC Export'''
    _name = 'banking.export.bac'
    ...
    _columns = {
        'payment_order_ids': fields.many2many(
            'payment.order',
            'account_payment_order_bac_rel',
            'banking_export_bac_id', 'account_order_id',
            'Payment Orders',
            readonly=True),
        'identification':
        ...
        'file':
            fields.binary('BAC File', readonly=True),
        'state':
            fields.selection([
                ('draft', 'Draft'),
                ('sent', 'Sent'),
