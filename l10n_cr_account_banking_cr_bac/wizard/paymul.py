...
class NorthAmericanAccount(CRAccount):
...
class Message(LogicalSection):
    ...
    def segments(self):
        # BAC only accepts one message per interchange
...
# values per section 2.8.5 "PAI, Payment Instructions" of "BAC - CRG Paymul Message Implementation Guide"
