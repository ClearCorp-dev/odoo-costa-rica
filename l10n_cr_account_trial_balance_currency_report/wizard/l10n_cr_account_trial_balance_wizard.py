...
class trialBalancereportWizard(osv.osv_memory):
    ...
    _name = "trial.balance.currency.report.wiz"
    _description = "Trial Balance Currency Report Wizard"
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        report_name = 'l10n_cr_account_trial_balance_currency_report.report_trial_balance_currency'
