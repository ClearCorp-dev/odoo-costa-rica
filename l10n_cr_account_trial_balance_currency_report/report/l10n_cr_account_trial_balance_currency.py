...
class report_partnerledger(osv.AbstractModel):
    _name = 'report.l10n_cr_account_trial_balance_currency_report.report_trial_balance_currency'
    _inherit = 'report.abstract_report'
    _template = 'l10n_cr_account_trial_balance_currency_report.report_trial_balance_currency'
