...
<body>
    ...
    <div style="font-size: 20px; font-weight: bold; text-align: center;"> ${bank_account.name}${bank_account.currency_id and (' - ' + bank_account.currency_id.code) or ''}</div>
    <div align="center">
        <div class="act_as_table data_table" style="margin-top:20px; margin-bottom: 10px; width:500px">
            <div class="act_as_row labels">
                ...
                <div class="act_as_cell" style = "width: 150px; font-size: 14px; font-weight: bold; text-align: left">${_('Balance according Bank')}</div>
            ...
            <div class="act_as_row labels">
                <div class="act_as_cell" style = "font-size: 14px; font-weight: bold; text-align: left">${_('Ledger Balance')}</div>
            ...
            <div class="act_as_row labels">
                <div class="act_as_cell" style = "font-size: 14px; text-align: left">${_('+ Incomes to register')}</div>
                <div class="act_as_cell amount" style = "font-size: 14px">${formatLang(bank_balance['incomes_to_register'])}</div>
            ...
            <div class="act_as_row labels">
                <div class="act_as_cell" style = "font-size: 14px; text-align: left">${_('- Expenditures to register')}</div>
                <div class="act_as_cell amount" style = "font-size: 14px">${formatLang(bank_balance['expenditures_to_register'])}</div>
            ...
            <div class="act_as_row labels">
                <div class="act_as_cell" style = "font-size: 14px; font-weight: bold; text-align: left; width: 90px;">${_('Ledger reconciled Total')}</div>
                ...
                <div class="act_as_cell" style = "font-size: 14px; font-weight: bold; text-align: left; width: 90px;">${_('Bank reconciled Total')}</div>
